...
# create binary predictor with no for num value v0 and yes otherwise
...
plot(trestbps ~ age, data = hd_trn, pch = 20,
     col = hd_trn$heart)
grid()
legend("bottomright", c("No", "Yes"), title = "Heart Disease", col = hd_trn$heart, pch = 20)
```
